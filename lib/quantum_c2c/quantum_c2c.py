...
class AutoEncoder(nn.Module):
    ...
    def __init__(self,input_shape,encoded_len):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Sigmoid(),
            Reshape(input_shape[-2],input_shape[-1]),
        )
...
def quantum_c2c(X_train_autoencoder,X_train,X_test,data_shape,autoencoder_model,quantum_curcuit,saving_folder,epochs=10,encoded_len=2):
    ...
    input_len=data_shape[-1]*data_shape[-2]
